...
# Use beta_columns to create a 2-column layout to display charts side by side
...
with col1:
    ...
    # Function 1
    def timeseries_embed_code(topic: str, country: str, start_date: date, end_date: date) -> str:
        """
...
with col2:
    st.write("Related Topics and Queries")

    # Function 2
    def related_queries_embed_code(topic, country, start_date, end_date):
        """
...
if start_date and end_date:
    google_trends_embed_code = timeseries_embed_code(selected_topic, selected_country, start_date, end_date)
